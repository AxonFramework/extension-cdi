<!--
Thanks for taking the time to draft up an issue for Axon Framework's CDI Extension!
Prior to starting off, please read the following:

## Usage Questions
 
If you are having difficulty using the CDI Extension, please take the following into account first:
...
You can find all three of them [here](https://github.com/AxonFramework/extension-cdi/issues/new/choose). 
