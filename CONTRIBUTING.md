...
Thank you for your interest in contributing to the Axon Framework CDI Extension. To make sure using Axon is a smooth
...
1. You can report any bugs, feature requests or ideas about improvements on
   our [issue page](https://github.com/AxonFramework/extension-cdi/issues/new/choose). All ideas are welcome. Please
...
CDI Extension, and that we won't hold you liable for any unfortunate side effects that the code may cause.

To sign the CLA, visit: https://cla-assistant.io/AxonFramework/extension-cdi
